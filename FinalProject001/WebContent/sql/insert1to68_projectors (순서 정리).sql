...
, REASON            VARCHAR2(★)  NOT NULL
, CONSTRAINT REP_REASON_NO_PK PRIMARY KEY(REP_REASON_NO)
);

--[8] 신고 처리 결과
CREATE TABLE REPORT_RESULT
( REP_RESULT_NO     NUMBER(★)
, RESULT            VARCHAR2(★)   NOT NULL
...
, CONSTRAINT DO_TYPE_NO_CK CHECK(DO_TYPE_NO = 1 OR DO_TYPE_NO = 0 )
);
...
, CONSTRAINT USER_PIN_NO_FK FOREIGN KEY(PIN_NO)
                            REFERENCES USER_PIN(PIN_NO)
);

--[17] 세부 지역
CREATE TABLE SUB_REGION
( SUB_REGION_NO     NUMBER(★)
, REGION_NO         NUMBER(★)       NOT NULL
, SUB_REGION_NAME   VARCHAR2(★)     NOT NULL
...
( WD_TYPE_NO        NUMBER(★)
, WD_TYPE_CONTENT   VARCHAR2(★) NOT NULL
...
, SUB_REGION_NO NUMBER(★)    NOT NULL
, UTOOL_NO      NUMBER(★)   NOT NULL 
, PROFILE_DATE  DATE    DEFAULT SYSDATE
, CONSTRAINT PROFILE_NO_PK PRIMARY KEY(PROFILE_NO)
, CONSTRAINT PIN_NO_FK  FOREIGN KEY(PIN_NO)
                        REFERENCES USER_PIN(PIN_NO)
, CONSTRAINT POSITION_NO_FK FOREIGN KEY(POSITION_NO)
