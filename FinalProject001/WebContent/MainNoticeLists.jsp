		...
		<div id="wrapper">
			...
			<div id="mainNoticeListBox" name="mainNoticeListBox"> <!-- 테이블 영역 -->
				<table id="mainNoticeLists">
					...
					<tr>
						<td>11</td>
						<td><a href="MainNoticeArticle.jsp">배고파용 배고파용.</a></td>
						<td>관리자2</td>
						<td>2023.08.01</td>
					</tr>
					<tr>
						<td>10</td>
						<td><a href="MainNoticeArticle.jsp">사이트 이용 정책이 추가되었습니다.</a></td>
						<td>관리자1</td>
						<td>2023.07.31</td>
					</tr>
					<tr>
...
<!--  준복이거 원본 
			...
			<div id="MainNoticeLists" name="MainNoticeLists">
				10|<a href="MainNoticeArticle.jsp">제목</a>|작성자|작성일<br>
				9|<a href="MainNoticeArticle.jsp">제목</a>|작성자|작성일 <br>
				8|<a href="MainNoticeArticle.jsp">제목</a>|작성자|작성일 <br>
				7|<a href="MainNoticeArticle.jsp">제목</a>|작성자|작성일 <br>
				6|<a href="MainNoticeArticle.jsp">제목</a>|작성자|작성일 <br>
				:|<a href="MainNoticeArticle.jsp">제목</a>|작성자|작성일 <br>
				1|<a href="MainNoticeArticle.jsp">제목</a>|작성자|작성일 <br>
			</div> 
			-->